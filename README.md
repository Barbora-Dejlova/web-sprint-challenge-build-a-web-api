...
Middleware are simply functions that have access to the request and response.
...
Express routers help us to create handlers -  extend this routing to handle validation, handle 404 or other errors. 

1. Describe tooling used to manually test the correctness of an API.

We can use postman(or insomnia) to verify correct HTTP status code and reponses.
